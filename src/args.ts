...
export const args: ArgDescriptor[] = [
    ...
    {
        name: 'starter',
        description: 'The name of the remote starter. Basically the user\'s repository name you want to clone.',
        type: String,
        defaultOption: true
    },
    {
        name: 'version',
        alias: 'v',
        description: 'The version of the remote starter. If not specified, defaults to last version.',
        type: String,
        defaultValue: 'last'
    },
    {
